		  ...
		  <form method="POST" class="tutorial">
                        ...
                        <tr>
                            <th>
                                ...
                                <label class="col-sm-2 col-form-label" for="titleLabel">Nom</label>
                                    <input type="text" class="form-control form-control-tutorial <?php if(isset($errors['titleAdd'])) { echo 'is-invalid'; } ?>" id="titleLabel" name="titleAdd" placeholder="Nom du produit" style="width: 300px;">
					...
					<table>
                        <tr>
                            <th>
                                <div class="form-group">
                                    <label for="catSelectLabel">Groupe parent</label>
